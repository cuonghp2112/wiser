...
// and switched to BERT features
{
  ...
  "validation_data_path": "output/generative/link_hmm/output/generative/link_hmm/dev_data.p",
  "test_data_path": "output/generative/link_hmm/output/generative/link_hmm/test_data.p",
