...
class SrlReaderIOB1(SrlReader):
    ...
    def _read(self, file_path: str):
        ...
        if self._domain_identifier is not None:
            logger.info(
                "Filtering to only include file paths containing the %s domain", self._domain_identifier)
